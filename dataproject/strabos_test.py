...
# Data
n_groups = 4
Home_Win = (0.2, 0.3, 0.4, -0.2591842105263158)
Draw = (0.1, 0.2, 0.3, -0.01960526315789468)
Away_Win = (0, 0.02, 0.1, 0.050473684210526226)
...
plt.xticks(index + bar_width, ('15/16', '16/17', '17/18', '18/19'))
plt.legend()
